...
export default function HistorySection() {
  ...
  return (
    // EL ID "historia" ES CLAVE PARA QUE LA NAVBAR LO ENCUENTRE
    <section id="historia" className="py-24 px-6 relative bg-esoft-dark border-t border-white/5 scroll-mt-24">
